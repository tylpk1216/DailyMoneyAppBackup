...
public class SearchActivity extends ContextsActivity implements android.view.View.OnClickListener {
    ...
    private void initialCriteria() {
        ...
        //5 years ago
        int wantYear = today.getYear() + 1900 -5;
        String input = new String().format("%04d-%02d-%02d", wantYear, 1, 1); 
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
                
        try {
            startday = formatter.parse(input);
        } catch (ParseException e) {
            startday = today;
        }     
        
        dateFromEditor = (EditText) findViewById(R.id.search_from_date);
        dateFromEditor.setText(format.format(startday));
