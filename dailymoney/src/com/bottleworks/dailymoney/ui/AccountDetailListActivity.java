...
//        detailListHelper.reloadData(idp.listAllDetail());
        GUIs.doBusy(this,new GUIs.BusyAdapter() {
            ...
            public void run() {
                ...
                //tylpk 20120408
                if(originalInfo.equals(i18n.string(R.string.label_prefs_specialexpense)))
                {
                	String searchRule = "nt_ like '%"+getContexts().getPrefSpecialExpense()+"%' AND tot_='B' AND frt_!='A'";
                	
                	data = idp.listSearchDetail(searchRule,startDate,endDate,getContexts().getPrefMaxRecords());
                	count = idp.countSearchDetail(searchRule,startDate,endDate);
                }
                else
                {
