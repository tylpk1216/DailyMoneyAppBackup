...
public class DetailEditorActivity extends ContextsActivity implements android.view.View.OnClickListener {
    ...
    private void initialSpinner() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item,
                new String[] { i18n.string(R.string.puitem_year), i18n.string(R.string.puitem_month),
                               i18n.string(R.string.puitem_day)
                             });
    ...
    private class SimpleAdapterEx extends SimpleAdapter {
        ...
        // NamedItem item =
        // (NamedItem)((Map)this.getItem(position)).get(spfrom[0]);
    ...
    private class AccountViewBinder implements SimpleAdapter.ViewBinder {
        ...
        public boolean setViewValue(View view, Object data, String text) {
            ...
            if (!ddPaddingBase_set) {
                ...
                // ddDisabled =
                // DetailEditorActivity.this.getResources().getDrawable(android.R.color.darker_gray).mutate();
            ...
            if (Constants.DISPLAY.equals(name)) {
                ...
                if (tv.getId() == R.id.simple_spdditem_display) {
                    tv.setPadding((int) (ddPaddingLeftBase + tn.getIndent() * ddPaddingIntentBase), tv.getPaddingTop(),
