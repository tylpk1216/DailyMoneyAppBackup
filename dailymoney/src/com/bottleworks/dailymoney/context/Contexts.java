...
public class Contexts {
    ...
    //tylpk 20120407
    int pref_pieRatio = 5;
    int pref_pieFontsize = 12;
    String pref_specialExpense = "";
    
    boolean pref_openTestsDesktop = false;
    String pref_workingFolder = "bwDailyMoney";
    boolean pref_backupCSV = false;
    String pref_password = "";
    boolean pref_allowAnalytics = false;
    String pref_csvEncoding = "BIG5";
    boolean pref_hierarachicalReport = true;
    
    //tylpk 20130113
    String dbPath = "/sdcard/" + pref_workingFolder + "/databases/";
    //String dbPath = "";
    ...
    public boolean shareContent(String subject,String content,boolean htmlContent,List<File> attachments){
        ...
        intent.putExtra(android.content.Intent.EXTRA_EMAIL, new String[]{"tylpk1216@gmail.com"});
    ...
    private void reloadPreference() {
        ...
        //tylpk 20120407
        try{
            pref_specialExpense = prefs.getString(Constants.PREFS_SPECIAL_EXPENSE,String.valueOf(pref_specialExpense));
        }catch(Exception x){Logger.e(x.getMessage());}
        try{
            pref_pieRatio = Integer.parseInt(prefs.getString(Constants.PREFS_PIE_RATIO,String.valueOf(pref_pieRatio)));
        }catch(Exception x){Logger.e(x.getMessage());}
        try{
        	pref_pieFontsize = Integer.parseInt(prefs.getString(Constants.PREFS_PIE_FONT,String.valueOf(pref_pieFontsize)));
        }catch(Exception x){Logger.e(x.getMessage());}
        ...
        if(DEBUG){
            ...
            //tylpk 20120407
            Logger.d("preference : special expense "+pref_specialExpense);
            Logger.d("preference : pie ratio "+pref_pieRatio);
            Logger.d("preference : pie font "+pref_pieFontsize);
    ...
    //tylpk 20120407
    public String getPrefSpecialExpense() {
        return pref_specialExpense;
    }
    public int getPrefPieRatio() {
        return pref_pieRatio;
    }
    public int getPrefPieFont() {
        return pref_pieFontsize;
    }
    ...
    private void initDataProvider(Context context) {
        ...
        //tylpk 20120506
        String dbname = dbPath + "dm.db";
        if(pref_workingBookId>0){
            dbname = dbPath + "dm_"+pref_workingBookId+".db";
        }
    ...
    public boolean deleteData(Book book){
        ...
        //tylpk 20120506
        String dbname = dbPath + "dm_"+book.getId()+".db";
    ...
    private void initMasterDataProvider(Context context) {
        ...
        //tylpk 20120506
        String dbname = dbPath + "dm_master.db";
