...
public interface IDataProvider {
    ...
    //tylpk 20120408
    List<Detail> listSearchDetail(String SearchRule, Date start, Date end, int max);
    int countSearchDetail(String SearchRule, Date start, Date end);
    ...
    //tylpk 20120408
    double sumSpecialExpenseValue(String specialExpense, Date start, Date end);
