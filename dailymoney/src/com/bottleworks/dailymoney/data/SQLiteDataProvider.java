...
public class SQLiteDataProvider implements IDataProvider {
    ...
    //tylpk 20120408
    @Override
    public List<Detail> listSearchDetail(String SearchRule, Date start, Date end, int max) {
        SQLiteDatabase db = helper.getReadableDatabase();
        
        StringBuilder where = new StringBuilder();
        where.append(SearchRule);
    ...
    @Override
    public int countSearchDetail(String SearchRule, Date start, Date end){
        SQLiteDatabase db = helper.getReadableDatabase();
    ...
    //tylpk 20120408
    @Override
    public double sumSpecialExpenseValue(String specialExpense, Date start, Date end) {
        SQLiteDatabase db = helper.getReadableDatabase();
        ...
        //only expense transaction, and credit is not revenue.
        where.append(" WHERE nt_ like '%").append(specialExpense).append("%'").append(" AND tot_='B' AND frt_!='A' ");
        ...
        query.append("SELECT SUM(mn_) FROM ").append(TB_DET).append(where);
